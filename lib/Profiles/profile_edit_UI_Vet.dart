...
class editProfileScreenVet extends StatelessWidget {
  final DocumentSnapshot ownerVet;
  final UserRepository _userRepository = UserRepository();
  editProfileScreenVet({ Key? key, required this.ownerVet})
      : super(key: key);
...
class editProfileVet extends StatefulWidget {
  final DocumentSnapshot ownerVet;
  editProfileVet(this.ownerVet);

  @override
  _editProfileVetState createState() => _editProfileVetState( ownerVet:ownerVet);
}

class _editProfileVetState extends State<editProfileVet> {
  final UserRepository _userRepository = UserRepository();
  final DocumentSnapshot ownerVet;
  _editProfileVetState({required this.ownerVet});
    ...
    return BlocListener<editBlocOrg, ProfileState>(
      listener: (context, state) {
        ...
        if (state.isSuccess!) {
          ...
          _userRepository.UpdateOrg(ownerVet, nameController.text,  emailController.text, phoneController.text, _city.toString(), desController.text);
          Navigator.push(
            context,
            new MaterialPageRoute(builder: (context) => new ProfileViewVet()),
          );
        }
      },
                      ...
                      ElevatedButton(
                        onPressed:(){
                          ...
                          Navigator.pop(
                              context,
                              MaterialPageRoute(
                                  builder: (BuildContext context) => ProfileViewVet()));
        ...
        child:  Padding(
          ...
          child: Column(
              ...
              children: <Widget>[
                ...
                TextFields(ownerVet,'name',nameController),
                TextFields(ownerVet,'email',emailController),
                TextFields(ownerVet,'phone',phoneController),
                city(),
                TextFields(ownerVet,'description',desController),

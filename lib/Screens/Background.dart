      ...
      body: Column(
        children: <Widget>[
          new Stack(
            ...
            children: <Widget>[
              Image.asset('assets/pickimage.png', width: MediaQuery.of(context).size.width/1.5,),
              WavyHeader(0),
            ],
          ),
          Expanded(
...
class WavyHeader extends StatefulWidget {
  ...
  WavyHeader(this.currentPage);


  @override
  _WavyHeaderState createState() => _WavyHeaderState();
}

class _WavyHeaderState extends State<WavyHeader> {
  @override
  Widget build(BuildContext context) {
    return Opacity(
      opacity: 0.5,
        ...
        children: [
          ClipPath(
            ...
            child: Container(
              ...
              height:(widget.currentPage==0)? MediaQuery.of(context).size.height / 2.9:

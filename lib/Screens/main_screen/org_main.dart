...
import 'package:petzone/Screens/adoption_request/org_request_screen.dart';
import 'package:petzone/Screens/homepage/home_page.dart';

import '../../constants.dart';
import '../profile_screen.dart';

final OrgGlobalKey = GlobalKey();
...
class _orgScreenState extends State<orgScreen> {
  ...
  Map<String, WidgetBuilder> _routeBuilders(BuildContext context, int index) {
    return {
      '/': (context) {
        return [new homePage(), new orgRequestScreen(), new ProfileScreen()]
            .elementAt(index);
      },
    };
  }
